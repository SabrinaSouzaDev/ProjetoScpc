...
export function SolicitacaoFolgaDialog({
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-full md:min-w-[50rem] lg:min-w-[60rem]">
        <DialogHeader>
          <DialogTitle className="text-[1.1rem] md:text-[1.2rem] lg:text-[1.4rem]">
            Folgas
          </DialogTitle>
          <DialogDescription className="text-[1rem] md:max-w-[92%] lg:text-[1.1rem]">
            Selecione o dia de acordo com a quantidade de folgas solicitadas. O
            máximo é 1 folga por solicitação{' '}
          </DialogDescription>
        </DialogHeader>
        <ScrollArea className="mb-auto flex h-full justify-center overflow-y-auto pt-2">
